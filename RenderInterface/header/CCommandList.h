...
namespace graphics_backend
{
	...
	public:
		...
		virtual CInlineCommandList& SetShaderBindings(std::vector<std::shared_ptr<ShaderBindingSet>> bindings, uint32_t firstBinding = 0) = 0;
		virtual CInlineCommandList& SetShaderBindings(std::vector<ShaderBindingSetHandle> bindings, uint32_t firstBinding = 0) = 0;
