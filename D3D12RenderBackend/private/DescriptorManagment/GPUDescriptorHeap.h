...
namespace graphics_backend
{
	...
	class DescriptorHeapAllocator : public D3D12SubobjectBase
	{
	public:
	...
	class GPUDescriptorHeap : public D3D12SubobjectBase
	{
	public:
	...
	class SamplerManager : public D3D12SubobjectBase
	{
	public:
